...
@Component({
  ...
  styleUrls: ['./dashboard-one.component.sass']
})
export class DashboardOneComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.redirectID = btoa(this.authService.currentUserValue.userid);
    const data = { id: this.authService.currentUserValue.userid };
    ...
    const latestlabRadioReport = {
      "member_id":this.authService.currentUserValue.userid,
    }
